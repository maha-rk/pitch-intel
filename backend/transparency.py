...
LIMITATIONS = {
    ...
    'pitch_agent': [
        "The agent only reasons over the 6 StatsBomb tools available to it — it has no information beyond this match's event data.",
        "Tool outputs are real numbers, but the agent's narrative connecting them is generated text — check the data shown in each tool call against the answer.",
        "What-if counterfactuals are the agent reasoning over momentum and xG patterns, not a re-simulation of the match — they are informed estimates, not predictions.",
    ],
    'fan_decoder': [
