...
const FAN_DECODER_LIMITATIONS = [
  "Answers are generated by IBM Granite, not a certified translator or commentator — verify anything high-stakes against an official source.",
  "Knowledge is general football context, not live access to in-progress matches beyond what's provided here.",
  "Voice input/output quality depends on the browser's built-in speech APIs, which vary by device and language.",
]
...
export default function FanDecoder() {
  ...
  const ask = async (q?: string) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${API_URL}/fan-decoder`, {
        method: 'POST',
  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh - 150px)', gap: 0, background: 'transparent' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '0 12px 10px' }}>
          <Limitations items={FAN_DECODER_LIMITATIONS} />
        </div>
      </div>
          ...
          {history.length === 0 && !loading && (
            <div style={{
              ...
              <div style={{ textAlign: 'center', marginBottom: 4 }}>
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#EC4899', opacity: 0.85, marginBottom: 8 }}>MODULE 08 · FAN INTELLIGENCE</div>
                <div style={{ fontFamily: "'Bebas Neue',sans-serif", lineHeight: 0.88 }}>
                  <span style={{ fontSize: 72, color: 'var(--t1)', letterSpacing: '0.05em' }}>FAN </span><span style={{ fontSize: 72, color: '#EC4899', letterSpacing: '0.05em', borderBottom: '3px solid #EC4899', paddingBottom: 4 }}>DECODER</span>
                </div>
              </div>
